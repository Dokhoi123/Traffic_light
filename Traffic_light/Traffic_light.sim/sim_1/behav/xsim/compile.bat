...
REM
REM Generated by Vivado on Mon Jul 28 20:36:49 +0700 2025
...
echo "xvlog --incr --relax -L uvm -prj Dengiaothongtest_vlog.prj"
call xvlog  --incr --relax -L uvm -prj Dengiaothongtest_vlog.prj -log xvlog.log
